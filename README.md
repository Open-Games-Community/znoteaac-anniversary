...
Default ZnoteAAC is the previous version before some errors start appears on servers like " Tibia might be in maintenance ".
This version is a default version of ZnoteAAC, you should not use this version, it is used for creating themes only.
