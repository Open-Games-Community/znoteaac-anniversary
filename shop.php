...
<?php if (!empty($category_items)): ?>
	<!-- ITEMIDS --><center><h3>Items</h3></center>
	<table id="cat_itemids" class="table table-striped table-hover">
	
		<tr class="">
			<td><b>Item:</td>
			<?php if ($config['shop']['showImage']) { ?><td><b>Image:</td><?php } ?>
			<td><b>Count:</td>
			<td><b>Points:</td>
			<?php if ($loggedin === true): ?><td><b>Action:</b></td><?php endif; ?>
		</tr>
			...
			<tr class="special">
				...
				<td>
					<form action="" method="POST">
						...
						<input type="submit" value="  PURCHASE  "  class="needconfirmation art-button" data-item-name="<?php echo $offers['description']; ?>" data-item-cost="<?php echo $offers['points']; ?>">
					</form>
				</td>
				<?php endif; ?>
			</tr>
...
<!-- PREMIUM DURATION --><br></br>
<center><h3> Premium </h3></center>
<table class="table table-striped table-hover" id="cat_premium">
	<tr class="yellow">
		<td><b><b>Description:</td>
		<?php if ($config['shop']['showImage']) { ?><td><b><b>Image:</td><?php } ?>
		<td><b><b>Duration:</td>
		<td><b><b>Points:</td>
		<?php if ($loggedin === true): ?><td><b><b>Action:</td><?php endif; ?>
	</tr>
...
<!-- OUTFITS --><br></br>
<center><h3> Outfits </h3></center>
<table class="table table-striped table-hover" id="cat_outfits">
	<tr class="yellow">
		<td><b>Description:</td>
		<?php if ($config['shop']['showImage']) { ?><td><b>Image:</td><?php } ?>
		<td><b>Points:</td>
		<?php if ($loggedin === true): ?><td><b>Action:</td><?php endif; ?>
	</tr>
...
<!-- MOUNTS --><br></br>
<center><h3> Mounts</h3></center>
<table class="table table-striped table-hover" id="cat_mounts">
	<tr class="yellow">
		<td><b>Description:</td>
		<?php if ($config['show_outfits']['shop']) { ?><td><b>Image:</td><?php } ?>
		<td><b>Points:</td>
		<?php if ($loggedin === true): ?><td><b>Action:</td><?php endif; ?>
	</tr>
...
<table class="table table-striped table-hover" id="cat_misc">
	<tr class="yellow">
		<td><b>Description:</td>
		<?php if ($config['shop']['showImage']) { ?><td><b>Image:</td><?php } ?>
		<td><b>Count/duration:</td>
		<td><b>Points:</td>
		<?php if ($loggedin === true): ?><td><b>Action:</td><?php endif; ?>
	</tr>
