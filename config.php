<?php
	...
	$config['site_title'] = 'Global Server';
	...
	$config['sqlUser'] = 'Your_PHP_myadmin_user';

	// phpmyadmin password for OT server:
	$config['sqlPassword'] = 'Your_PHP_myadmin_password';

	// The database name to connect to. (This is usually same as username).
	$config['sqlDatabase'] = 'Your_PHP_myadmin_database';
