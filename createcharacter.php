...
if (isset($_GET['success']) && empty($_GET['success'])) {
	echo '<font style="color:lime">Congratulations</font>! Your character has been created. See you in-game! <a href="myaccount.php" style="color:#007FE9"> Click here to go Back to your Account </a>.';
} else {
	...
	<form action="" method="post">
		<ul>
			...
			?>
			<br></br>
			<div>	<input type="submit" class="art-button" value="Create Character"></div>
