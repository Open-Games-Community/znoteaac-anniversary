...
if ($render_page) {
	...
	<?php
			...
			<a href="admin.php" >
				<input id="submit_button" type="submit" value="Admin Page" class="linkbuttons"></a>
				<a href="changelog.php" >
				<input id="submit_button" type="submit" value="Admin Changelog" class=""></a>
			<a href="admin_news.php" >
				<input id="submit_button" type="submit" value="Admin Create News" class=""></a>

			<a href="admin_gallery.php" >
				<input id="submit_button" type="submit" value="Admin Gallery" class=""></a>

			<a href="admin_skills.php" >
			<input id="submit_button" type="submit" value="Admin Skills" class=""></a>
			
			<a href="admin_reports.php" >
				<input id="submit_button" type="submit" value="Admin Reports" class=""></a>
		
			<a href="helpdesk.php" >
				<input id="submit_button" type="submit" value="Admin Tickets" class=""></a>
				

			<a href="admin_shop.php" >
				<input id="submit_button" type="submit" value="Admin Shop" class=""></a>
		
			<a href="admin_auction.php" >
				<input id="submit_button" type="submit" value="Admin Auction" class=""></a>
				<a href="forum.php?cat=4" >
				<input id="submit_button" type="submit" value="Feedback" class=""></a>
</center>
<?php
			}
			// end if admin
	...
	<div id="myaccount">
		...
		if ($char_array) {
					...
					<tr>
						...
						<td id="submit_form">
							<?php
								...
								Token::create();
							?>
							<input id="submit_button" type="submit" value="Submit" class=""></input>
						</td>
					</tr>
				</table>
			</form>
			...
			<td><a href="createcharacter.php" class="btn "><input id="submit_button" type="submit" value="Create Character" class="">
				</a>

			<td><a href="changepassword.php" class="btn ">
				<input id="submit_button" type="submit" value="Change Password" class=""></a>

			<td><a href="settings.php" class="btn ">
			<input id="submit_button" type="submit" value="Settings" class=""></a>
			
			<td><a href="logout.php" class="btn ">
				<input id="submit_button" type="submit" value="Logout" class=""></a>
		</tr></table>
